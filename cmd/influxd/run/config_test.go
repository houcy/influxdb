...
`, &c); err != nil {
	...
	} else if err := os.Setenv("INFLUXDB_HTTP_0_BIND_ADDRESS", ":8086"); err != nil {
		t.Fatalf("failed to set env var: %v", err)
	} else if err := os.Setenv("INFLUXDB_UDP_BIND_ADDRESS", ":1234"); err != nil {
		t.Fatalf("failed to set env var: %v", err)
	} else if err := os.Setenv("INFLUXDB_GRAPHITE_1_PROTOCOL", "udp"); err != nil {
		t.Fatalf("failed to set env var: %v", err)
	} else if err := os.Setenv("INFLUXDB_COLLECTD_1_BIND_ADDRESS", ":1020"); err != nil {
		t.Fatalf("failed to set env var: %v", err)
	} else if err := os.Setenv("INFLUXDB_OPENTSDB_0_BIND_ADDRESS", ":2020"); err != nil {
		t.Fatalf("failed to set env var: %v", err)
	}
